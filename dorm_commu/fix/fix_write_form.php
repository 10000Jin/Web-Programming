...
<script>
  function check_input() {								// 자바 스크립트 함수 완료 버튼 클릭시 호출
      ...
      document.fix_form.submit();						// fix_insert.php로 전달
   }
</script>
</head>
<body> 
...
<section>
	...
	<div id="main_content">
		<div id="sub_menu">												<!-- 초록색 서브메뉴 -->
	   	...
	   	<div id="fix_box">
		    <div id="fix_title">
		    	<span>고장/수리 요청 > 글 쓰기</span>
			</div>
			<div id="fix_form">
		    	<form  name="fix_form" method="post" action="fix_insert.php" enctype="multipart/form-data">		 	<!-- post방식 파일 업로드 위해 enctype을 multipart/form-data로 설정-->
		    	 <ul>
					<li>
