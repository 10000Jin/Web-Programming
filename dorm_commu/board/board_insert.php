...
<?php
	...
	$upload_dir = $_SERVER["DOCUMENT_ROOT"].'/2017136130_텀프로젝트_최만진/data/board_data/';									// 업로드 파일 저장 폴더 
	...
	$sql = "insert into board (id, name, title, content, regist_day, count,  file_name, file_type, file_copied) ";											// MySQL 명령 설정
	...
	echo "
	   <script>
	    location.href = 'board_list_form.php';
	   </script>
	";
?>
